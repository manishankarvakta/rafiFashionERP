...
async function main() {
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log("🧹  RANGPUR (Hub) WAREHOUSE DATA CLEAN-UP SCRIPT");
  console.log(`🛡️  Current Mode: ${DRY_RUN ? "🔍 DRY RUN (Safe mode)" : "⚠️  LIVE WRITE (Modifying DB)"}`);
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");

  const WAREHOUSE_CODE = "WH-2026-0004";
  const NAME_CHECK = "RANGPUR";
  ...
  // A voucher is related if it matches any of these criteria:
  // 1. Direct link to warehouseId
  // 2. Linked via Sale.voucherId or Adjustment.voucherId
  // 3. Reference is one of the saleNumbers or adjustmentNumbers
  // 4. Description contains one of the saleNumbers or adjustmentNumbers
  ...
  console.log("--------------------------------------------------------");
  console.log("📊 ANALYSIS SUMMARY REPORT FOR RANGPUR:");
  console.log("--------------------------------------------------------");
  ...
  if (DRY_RUN) {
    ...
    console.log(`   env DRY_RUN=false npx tsx scripts/cleanup-rangpur-only.ts\n`);
    process.exit(0);
  }
  ...
  try {
    ...
    console.log("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    console.log("✅ SUCCESS: Rangpur Hub data clean-up completed successfully!");
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");
  } catch (error) {
