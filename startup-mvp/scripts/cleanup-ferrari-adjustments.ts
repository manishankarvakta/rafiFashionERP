...
async function main() {
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log("🧹  FERRARI FASHION (Aziz Super) WAREHOUSE CLEAN-UP SCRIPT");
  console.log(`🛡️  Current Mode: ${DRY_RUN ? "🔍 DRY RUN (Safe mode)" : "⚠️  LIVE WRITE (Modifying DB)"}`);
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");

  const WAREHOUSE_CODE = "WH-2026-0003";
  const NAME_CHECK = "FERRARI FASHION";
  ...
  // B. Stock Ledgers to delete (Only ADJUSTMENT type)
  ...
  const ledgersToKeepCount = await prisma.stockLedger.count({
    where: {
      warehouseId: whId,
      referenceType: { not: "ADJUSTMENT" }
    }
  });

  // C. Find Related Vouchers & Journal Entries (only related to adjustments)
  ...
  const candidateVouchers = await prisma.voucher.findMany({
    where: {
      OR: [
        { id: { in: adjVoucherIds } },
        { reference: { in: adjustmentNumbers } },
  ...
  console.log("--------------------------------------------------------");
  console.log("📊 ANALYSIS SUMMARY REPORT FOR FERRARI FASHION:");
  console.log("--------------------------------------------------------");
  ...
  if (DRY_RUN) {
    ...
    console.log(`   env DRY_RUN=false npx tsx scripts/cleanup-ferrari-adjustments.ts\n`);
    process.exit(0);
  }
  ...
  try {
    ...
    console.log("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    console.log("✅ SUCCESS: Ferrari Fashion data clean-up completed successfully!");
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");
  } catch (error) {
