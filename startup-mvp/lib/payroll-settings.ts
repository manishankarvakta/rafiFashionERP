...
function mergeCalculation(
  ...
  return {
    ...
    enableWorkHoursThresholds:       partial?.enableWorkHoursThresholds       ?? def.enableWorkHoursThresholds,
    minHoursForFullDay:              partial?.minHoursForFullDay              ?? def.minHoursForFullDay,
    minHoursForHalfDay:              partial?.minHoursForHalfDay              ?? def.minHoursForHalfDay,
    halfDayGrossSalaryPayPercentage: partial?.halfDayGrossSalaryPayPercentage ?? def.halfDayGrossSalaryPayPercentage,
    halfDayCalculationBasis:         partial?.halfDayCalculationBasis         ?? def.halfDayCalculationBasis,
